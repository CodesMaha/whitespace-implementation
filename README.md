...
To finish one instruction, `-1` can be appended on a separate line as a sentinel value. Conversely, the program can be terminated by the Whitespace instruction `\n\n\n`.
